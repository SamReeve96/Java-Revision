...
/**
 * Frontend has methods which do alter what is seen by the user 
 * and handles what the user does i.e. clicking a button
...
public class Frontend extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlMessages.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Message(s):"));
        pnlMessages.setToolTipText("");
        ...
        lblUserMessage.setToolTipText("All messages will appear here");
        ...
        pnlMessagesLayout.setVerticalGroup(
            ...
            .addGroup(pnlMessagesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pnlMessagesLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(lblUserMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                    .addContainerGap()))
        );
    ...
    /**
     * When the clear all button is pressed all contents of the window is removed
     * this includes all text-boxes, the order table 
     * and contents of the basket. The radio buttons are reset to false.
     * and Combo-boxes are set to selectedIndex 0
     * @param evt 
     */
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearActionPerformed
        //Remove contents of Fields
        clearFields();
    ...
    /**
     * Validates the input from the user to create a pipe and add it to the basket 
     * if its not valid tell the user whats wrong.
     * @param evt 
     */
    private void btnAddToBasketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToBasketActionPerformed
        /* Initalise local vars, errString is used to display errors to the user 
        and prevent an erronous creation of a pipe */
        String errString = "";
        String pipeCreated = "";
        double length = 0.00;
        ...
        // alter the values of the raido button variables if they're true
        ...
        /* if the inputs are valid, work out what type of pipe is being made 
        return an exception if there is no such type of pipe, add it to errString */
        if (errString.equals("")){
            try{ 
        ...
        /*If there are no errors then add the basket contents to the table and 
        set the totalCost. If there are erros update the user message Lable */
        if (errString.equals("")){
            addBasketToTable();
            lblTotalCostVar.setText(formatter.format(Bcknd.totalCostOfOrder()));
            clearFields();
    ...
    /**
     * Removes a selected pipe from the basket and jFrame, then re-calcs the total cost
     * @param evt 
     */
    ...
    /**
     * Once all pipes have been added to the order, completeOrder will write 
     * the contents of the order to a file.
     * @param evt 
     */
    private void btnCompleteOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompleteOrderActionPerformed
        if (Backend.basket.isEmpty()){lblUserMessage.setText("Error: Please add Pipes to order");}
            ...
            try {
                ...
                Bcknd.writeToFile();
                //Clear contents of jTable and basket re-calc totalCost ( = 0.00)
                clearFields();
                DefaultTableModel model = (DefaultTableModel) tblOrder.getModel();
                model.setRowCount(0);
                Bcknd.basket.clear();
    ...
    //Create an instance of backend so that frontend can access the basket 
    //arraylist and call backend methods
    Backend Bcknd = new Backend();
    NumberFormat formatter = NumberFormat.getCurrencyInstance();

    /**
     * This will reset all the fields on the form that the user inputs pipe details into
     */
    public void clearFields(){
        ...
        lblUserMessage.setText("Window Cleared");
    }
    
    /**
     * Adds the contents of the basket arrayList to the jTable, so the user can see what is currently being ordered
     */
