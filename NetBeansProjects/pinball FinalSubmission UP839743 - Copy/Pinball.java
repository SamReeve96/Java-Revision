import java.awt.*;
/**
 * A pinball object, all pinball types have a score, so is set here. a Pinbasll can also be set to "Removed" is it goes in hole and is small enough.
 * also has the fames to delay, which is called after a pinball collision
 *
 * @author (UP839743)
